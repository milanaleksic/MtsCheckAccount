# Auto-generated by EclipseN0.IS Script Wizard
# 02.06.2009. 20.35.44

Name "mt:s Check Account ${ARCHITECTURE}"
...
!define INSTALL_SOURCE "install-${ARCHITECTURE}"
...
!insertmacro MUI_PAGE_LICENSE "${INSTALL_SOURCE}\License.txt"
...
Section -Main SEC0000
    ...
    SetOutPath $INSTDIR
    Delete "*.*"
    File ${INSTALL_SOURCE}\Startup.exe
    File ${INSTALL_SOURCE}\License.txt
    File ${INSTALL_SOURCE}\ProcitajMe.txt

    SetOutPath $INSTDIR\bin
    Delete "*.*"
    File ${INSTALL_SOURCE}\bin\*

    SetOutPath $INSTDIR\lib
    Delete "*.jar"
    File ${INSTALL_SOURCE}\lib\*
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\Startup.exe
